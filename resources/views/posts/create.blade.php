                    ...
                    <div class="card-body">
                        <form action="{{ route('posts.store') }}" method="POST" enctype="multipart/form-data">
                            ...
                            <div class="form-group">
                                ...
                                <input type="file" class="form-control @error('foto_penduduk') is-invalid @enderror" name="foto_penduduk">
                            ...
                            <div class="form-group">
                                ...
                                <textarea class="form-control @error('nama_penduduk') is-invalid @enderror" name="nama_penduduk" rows="5" placeholder="Masukkan Nama Penduduk">{{ old('nama_penduduk') }}</textarea>
